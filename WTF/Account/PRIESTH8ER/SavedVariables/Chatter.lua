	...
	["namespaces"] = {
		...
		["Editbox History"] = {
			["realm"] = {
				...
				["Arthas"] = {
					["history"] = {
						"/cw Tydeson-Arthas yea", -- [1]
						"/p dots on call now", -- [2]
						"/p we'll go again after he gest done", -- [3]
						"/cw Jeevelite-Arthas ?", -- [4]
						"/cw Jeevelite-Arthas buy from honor vendor", -- [5]
						"/cw Cabron-Arthas fun so far", -- [6]
						"/cw Cabron-Arthas gonna be nerfed, op dps", -- [7]
						"/wa", -- [8]
						"/fen", -- [9]
						"/fen", -- [10]
						"/wa", -- [11]
