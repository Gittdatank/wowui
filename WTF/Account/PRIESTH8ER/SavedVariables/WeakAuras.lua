...
WeakAurasSaved = {
	["displays"] = {
		...
		["Interrupter Main"] = {
			...
			["frameStrata"] = 1,
			["width"] = 159.000045776367,
			["id"] = "Interrupter Main",
			["font"] = "DorisPP",
			["numTriggers"] = 1,
			["xOffset"] = 56.25,
			["height"] = 23.249906539917,
			["animation"] = {
				["start"] = {
					["type"] = "none",
					["duration_type"] = "seconds",
	...
	["frame"] = {
		["xOffset"] = -605.2509765625,
		["yOffset"] = -202.499877929688,
