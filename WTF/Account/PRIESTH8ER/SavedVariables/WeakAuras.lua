...
WeakAurasSaved = {
	["displays"] = {
		...
		["Pulverize 2"] = {
			["sparkWidth"] = 10,
			["stacksSize"] = 12,
			["xOffset"] = 1.50006103515625,
			["stacksFlags"] = "None",
			["yOffset"] = -185.288146972656,
			["anchorPoint"] = "CENTER",
			["borderColor"] = {
				1, -- [1]
				1, -- [2]
	...
	["frame"] = {
		["xOffset"] = -364.500732421875,
		["yOffset"] = -485.249938964844,
