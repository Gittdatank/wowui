--
-- Starting in 5.4, sliders don't properly respect the step values causing OnValueChanged events
-- to receive fractional values. As detailed at http://www.wowwiki.com/Patch_5.4.0/API_changes#Slider,
