...
L["shard_explosion_desc"] = "為爆炸顯示獨立的計時器，如果你是近戰職業可選用。"
...
L["train"] = "列車"
L["trains"] = "列車警告"
L["trains_desc"] = "為下一班列車顯示計時器及訊息。軌道編號從王的位置排列至入口，例：王 1 2 3 4 入口。"
...
L["custom_off_markedfordeath_marker_desc"] = "標記死亡標記為 {rt1}{rt2}，需要團隊權限或隊長。"
