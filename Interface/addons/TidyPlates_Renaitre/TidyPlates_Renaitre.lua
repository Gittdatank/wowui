...
local path = "Interface\\Addons\\TidyPlates_Renaitre\\"
...
local DamageThemeName = "Renaitre/|cFFFF4400Damage"
local TankThemeName = "Renaitre/|cFF3782D1Tank"
...
--AddTidyPlatesHubStyle("Renaitre", StyleDefault, StyleTextOnly, WidgetConfig)
