...
function MarketWatcher.QueryServer(name, minLevel, maxLevel, invTypeIndex, classIndex, subclassIndex, page, isUsable, qualityIndex, getAll)
	if ( AucAdvanced and AucAdvanced.Scan and AucAdvanced.Scan.Private and AucAdvanced.Scan.Private.Hook and AucAdvanced.Scan.Private.Hook.QueryAuctionItems ) then
...
function MarketWatcher.GetItemInvType(equipLoc, classIndex, subclassIndex)
	if ( equipLoc and equipLoc ~= "" and classIndex and subclassIndex ) then
