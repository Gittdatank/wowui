...
OQ._difficulty = { [ 1] = { n =0.25, desc = L["5 player"]          },
                   [ 2] = { n =   1, desc = L["5 player (heroic)"] },
                   [ 3] = { n =   4, desc = L["10 player"]         },
                   [ 4] = { n =   8, desc = L["25 player"]         },
                   [ 5] = { n =   8, desc = L["10 player (heroic)"]},
                   [ 6] = { n =  10, desc = L["25 player (heroic)"]},
                   [ 7] = { n =   2, desc = L["LFR"]               },
                   [ 8] = { n =   3, desc = L["challenge mode"]    },
                   [ 9] = { n =   0, desc = L["40 player"]         },
                   [10] = { n =   0, desc = L["-"]                 },
                   [11] = { n =   2, desc = L["scenario (heroic)"] },
                   [12] = { n =   1, desc = L["scenario"]          },
                   [14] = { n =   3, desc = L["flex raid"]         },
                 } ;
